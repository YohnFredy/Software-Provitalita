<x-layouts.app>
    ...
    <section id="inicio" class="pt-28 pb-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                <div class="space-y-6">
                    <h1 class="text-4xl md:text-5xl font-bold leading-tight">Transforma tu futuro financiero con Network
                    </h1>
                    ...
                    <div class="pt-6 flex flex-col sm:flex-row gap-4">
                        <a href="#franquicias"
                            class="inline-block px-6 py-3 bg-white text-blue-700 rounded-md font-medium text-center hover:bg-gray-100 transition duration-150">Nuestras
                            Franquicias</a>
                        <a href="#contacto"
                            class="inline-block px-6 py-3 border-2 border-white text-white rounded-md font-medium text-center hover:bg-white hover:text-blue-700 transition duration-150">Comienza
                            Hoy</a>
                    </div>
                </div>
                <div class="hidden md:block">
                    <img src="https://adrnetworks.mx/wp-content/uploads/2024/03/Ahorro-1024x576.png"
                        alt="Network Oportunidades" class="rounded-lg shadow-xl">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div>
                    <img src="https://thefoodtech.com/wp-content/uploads/2025/02/vibrant-health-nutritional-power-pill.webp"
                        alt="Network Historia" class="rounded-lg shadow-lg">
                </div>
                <div class="space-y-6">
                    <div class="flex items-start">
                        <div class="bg-blue-600  rounded-full text-white mr-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Network se ha enfocado en el desarrollo de complementos
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Contamos con 8 años de investigación en sistemas de mercadeo en red
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Network es una propuesta especialmente adaptada para el mercado
                    ...
                    <div class="mt-8">
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-center">
                                ...
                                <span class="text-gray-600">Entregar un sistema que permita el desarrollo de redes
                            ...
                            <li class="flex items-center">
                                ...
                                <span class="text-gray-600">Reunir inversionistas para establecer unidades productivas
                            ...
                            <li class="flex items-center">
                                ...
                                <span class="text-gray-600">Llevar a sus asociados a alcanzar grandes metas con poca
                                    inversión.</span>
                            </li>
                        </ul>
                    </div>
    ...
    <section id="franquicias" class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="mt-4 text-xl text-gray-600">Franquicias que impactan en el ámbito deportivo, recreativo y
                    saludable</p>
                <div class="h-1 w-24 bg-blue-600 mx-auto mt-4"></div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Network Coffee -->
                <div
                    class="bg-white rounded-xl shadow-lg overflow-hidden transition-transform duration-300 hover:shadow-2xl hover:-translate-y-2">
                    <div class="relative">
                        <img src="https://thefoodtech.com/wp-content/uploads/2024/08/bebidas-con-cafeina-1.webp"
                            alt="Network Coffee" class="w-full h-64 object-cover">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">Una cafetería especializada en bebidas que combinan sabor y
                ...
                <div
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">Un lugar innovador donde las micheladas y las bebidas especiales
                ...
                <div
                    ...
                    <div class="relative">
                        <img src="https://vinculando.org/wp-content/uploads/bionatural-playa-del-carmen-2015.jpg"
                            alt="Provitalita" class="w-full h-64 object-cover">
                        <div class="absolute top-0 left-0 bg-blue-600 text-white py-2 px-4 rounded-br-xl">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">Un espacio dedicado a la salud natural, ofreciendo suplementos,
                            productos orgánicos y alimentos funcionales. Provitalita fomenta un enfoque integral de
                ...
                <div
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">Una tienda enfocada en ofrecer suplementos, ropa, accesorios y
                ...
                <!-- Net Inmobiliario -->
                <div
                    class="bg-white rounded-xl shadow-lg overflow-hidden transition-transform duration-300 hover:shadow-2xl hover:-translate-y-2 md:col-span-2 lg:col-span-1">
                    <div class="relative">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">Conjuga todas las modalidades inmobiliarias, brindando token
    ...
    <section id="inversion" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
                <div
                    class="bg-white p-8 rounded-xl border border-gray-200 shadow-lg hover:shadow-xl transition-shadow duration-300">
                    ...
                    <p class="text-gray-600 mb-6">La modalidad API permite al inversionista adquirir una fracción de la
                    ...
                    <a href="#contacto"
                        class="inline-flex items-center justify-center w-full px-6 py-3 mt-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition duration-300">
                        Más información
                    </a>
                </div>
                ...
                <div
                    ...
                    <p class="text-gray-600 mb-6">Esta modalidad permite al inversionista adquirir la franquicia como
            ...
            <div class="bg-gray-50 rounded-2xl p-8 md:p-12 shadow-lg border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Participa en proyectos específicos respaldados por la compañía,
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Conviértete en distribuidor de productos de las distintas marcas
                ...
                <div class="mt-8 text-center">
                    <a href="#contacto"
                        class="inline-block px-8 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition duration-300">
    ...
    <section id="diferencias" class="py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div
                    class="bg-white/10 rounded-xl p-6 backdrop-blur-sm hover:bg-opacity-20 transition duration-300 shadow-lg">
                    <div
                        class="rounded-full bg-white text-blue-600 w-16 h-16 flex items-center justify-center mx-auto mb-6">
                ...
                <div
                    ...
                    <p class="text-center">No te limites a tu lista de contactos. Network te abre las puertas a un
                ...
                <div
                    ...
                    <p class="text-center">Network respeta la inversión individual, de esta manera tus ingresos no solo
            ...
            <div class="mt-16 text-center">
                <a href="#contacto"
                    class="inline-block px-8 py-4 bg-white text-blue-700 rounded-md font-medium text-lg hover:bg-gray-100 transition duration-300">
                    Únete a Network hoy
                </a>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-gray-50 p-8 rounded-xl shadow-md">
                    ...
                    <p class="text-gray-600 italic">"Desde que me uní a Network, mi vida financiera cambió
                        completamente. La franquicia de Network Coffee no solo me ha dado estabilidad económica, sino
                ...
                <div class="bg-gray-50 p-8 rounded-xl shadow-md">
                    ...
                    <p class="text-gray-600 italic">"Lo que más me gusta de Network es su enfoque en el bienestar. Mi
                        inversión en Provitalita no solo ha sido rentable, sino que me ha permitido contribuir a la
                ...
                <div class="bg-gray-50 p-8 rounded-xl shadow-md">
                    ...
                    <p class="text-gray-600 italic">"Empecé como distribuidor de productos y ahora tengo mi propia
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                <div class="bg-white rounded-xl shadow-lg p-8">
                    ...
                    <form>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                <label for="interes" class="block text-sm font-medium text-gray-700 mb-1">Me
                                    interesa</label>
                        ...
                        <button type="submit"
                            class="w-full bg-blue-600 text-white py-3 px-4 rounded-md hover:bg-blue-700 transition duration-300 font-medium">
                            Enviar mensaje
                        </button>
                    </form>
                </div>
                ...
                <div class="bg-blue-600 text-white rounded-xl shadow-lg overflow-hidden">
                    <div class="p-8">
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start">
                                <div class="bg-white rounded-full text-blue-600 mr-4">
                                    <div class="w-10 h-10 flex items-center justify-center">
                        ...
                        <div class="mt-8">
                            ...
                            <div class="flex space-x-4">
                                ...
                                <a href="#"
                                    class="bg-white text-blue-600 p-3 rounded-full hover:bg-gray-100 transition duration-300">
    ...
    <section class="py-16 bg-blue-800 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="text-xl mb-8">Únete a Network y descubre un nuevo camino hacia la libertad financiera y el
                    bienestar.</p>
                <a href="#contacto"
                    class="inline-block px-8 py-4 bg-white text-blue-700 rounded-md font-medium text-lg hover:bg-gray-100 transition duration-300">
                    Comienza hoy mismo
    ...
    <!-- Back to top button -->
    <button id="backToTop"
        class="fixed bottom-6 right-6 bg-blue-600 text-white w-12 h-12 rounded-full flex items-center justify-center shadow-lg hover:bg-blue-700 transition duration-300"
