<x-layouts.app>
    ...
    <!-- Hero Section -->
    <section id="inicio" class="pt-28 pb-20 bg-gradient-to-r from-primary to-secondary text-white rounded-md ">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                <div class="space-y-6">
                    <h1 class="text-4xl md:text-5xl font-bold leading-tight">Transforma tu futuro financiero con
                        ActivosNetwork
                    </h1>
                    <p class="text-xl md:text-2xl font-light">Una compañía en el sector de salud y bienestar que ofrece
                        múltiples oportunidades financieras a través de un sistema global de asociación.</p>
                    <div class="pt-6 flex flex-col sm:flex-row gap-4">
                        <a href="#franquicias"
                            class="inline-block px-6 py-3 bg-white text-primary rounded-md font-medium text-center hover:bg-neutral-light transition duration-150">Nuestras
                            Franquicias</a>
                        <a href="#contacto"
                ...
                <div class="hidden md:block">
                    <img src="https://adrnetworks.mx/wp-content/uploads/2024/03/Ahorro-1024x576.png"
                        alt="ActivosNetwork Oportunidades" class="rounded-lg shadow-xl">
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- About Us Section -->
    <section id="nosotros" class="py-20 bg-neutral-50 ">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-primary">Nuestra Historia</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div class="space-y-6">
                    <div class="flex items-start">
                        <div class="bg-primary  rounded-full text-white mr-4">
                            <div class="w-10 h-10 flex items-center justify-center"><i
                                    class="fas fa-history text-xl"></i></div>
                        </div>
                        <div>
                            <h3 class="text-xl font-semibold text-primary mb-2">18 años de experiencia</h3>
                            <p class="text-ink">ActivosNetwork se ha enfocado en el desarrollo de complementos
                    ...
                    <div class="flex items-start">
                        <div class="bg-primary rounded-full text-white mr-4">
                            <div class="w-10 h-10 flex items-center justify-center"><i
                                    class="fas fa-globe-americas text-xl"></i></div>
                        </div>
                        <div>
                            <h3 class="text-xl font-semibold text-primary mb-2">Presencia internacional</h3>
                            <p class="text-ink">Contamos con 8 años de investigación en sistemas de mercadeo en red
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-primary mb-2">Propuesta innovadora</h3>
                            <p class="text-ink">ActivosNetwork es una propuesta especialmente adaptada para el mercado
                                latinoamericano, enfocada en apalancamiento, inversiones tangibles, sinergia y un nivel
                                comercial competitivo.</p>
                        </div>
                    </div>
                    <div class="mt-8">
                        <h3 class="text-xl font-bold text-primary mb-4">Nuestros objetivos</h3>
                        <ul class="space-y-3">
                            <li class="flex items-center">
                                <svg class="h-5 w-5 text-secondary mr-2" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                        clip-rule="evenodd"></path>
                                </svg>
                                <span class="text-primary">Entregar un sistema que permita el desarrollo de redes
                            ...
                            <li class="flex items-center">
                                ...
                                <span class="text-primary">Reunir inversionistas para establecer unidades productivas
                            ...
                            <li class="flex items-center">
                                ...
                                <span class="text-primary">Llevar a sus asociados a alcanzar grandes metas con poca
                                    inversión.</span>
                            </li>
                        </ul>
                    </div>
    ...
    <section id="franquicias" class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-primary">Nuestros Vehículos Financieros</h2>
                <p class="mt-4 text-xl text-secondary">Franquicias que impactan en el ámbito deportivo, recreativo y
                    saludable</p>
                <div class="h-1 w-24 bg-premium mx-auto mt-4"></div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <div class="relative">
                        <img src="https://thefoodtech.com/wp-content/uploads/2024/08/bebidas-con-cafeina-1.webp"
                            alt="ActivosNetwork Coffee" class="w-full h-64 object-cover">
                        <div class="absolute top-0 left-0 bg-primary text-white py-2 px-4 rounded-br-xl">
                            <i class="fas fa-coffee mr-2"></i> Cafetería
                        </div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-2xl font-bold text-primary mb-3">ActivosNetwork Coffee</h3>
                        <p class="text-ink mb-4">Una cafetería especializada en bebidas que combinan sabor y
                        ...
                        <a href="#contacto" class="inline-block mt-2 text-secondary font-medium hover:text-primary">
                ...
                <div
                    class="bg-white rounded-xl shadow-md shadow-ink overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-2">
                    <div class="relative">
                        <img src="https://i.pinimg.com/474x/74/e4/d9/74e4d91ad64ae9276bdcbcc7fa7657cd.jpg"
                            alt="Chelas" class="w-full h-64 object-cover">
                        <div class="absolute top-0 left-0 bg-primary text-white py-2 px-4 rounded-br-xl">
                            <i class="fas fa-cocktail mr-2"></i> Bar
                        </div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-2xl font-bold text-primary mb-3">Chelas</h3>
                        <p class="text-ink mb-4">Un lugar innovador donde las micheladas y las bebidas especiales
                ...
                <div
                    class="bg-white rounded-xl shadow-md shadow-ink overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-2">
                    <div class="relative">
                        <img src="https://vinculando.org/wp-content/uploads/bionatural-playa-del-carmen-2015.jpg"
                            alt="ActivosNetwork" class="w-full h-64 object-cover">
                        <div class="absolute top-0 left-0 bg-primary text-white py-2 px-4 rounded-br-xl">
                            <i class="fas fa-leaf mr-2"></i> Tienda Naturista
                        </div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-2xl font-bold text-primary mb-3">ActivosNetwork</h3>
                        <p class="text-ink mb-4">Un espacio dedicado a la salud natural, ofreciendo suplementos,
                ...
                <div
                    class="bg-white rounded-xl shadow-md shadow-ink overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-2">
                    <div class="relative">
                        <img src="https://image.isu.pub/180831164102-722eed7180895424bf1609edf92f3c71/jpg/page_1_thumb_large.jpg"
                            alt="Maspro" class="w-full h-64 object-cover">
                        <div class="absolute top-0 left-0 bg-primary text-white py-2 px-4 rounded-br-xl">
                            <i class="fas fa-dumbbell mr-2"></i> Tienda Deportiva
                        </div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-2xl font-bold text-primary mb-3">Maspro</h3>
                        <p class="text-ink mb-4">Una tienda enfocada en ofrecer suplementos, ropa, accesorios y
                            asesoría de alta calidad para el desempeño óptimo de deportistas de todos los niveles.</p>
                        <a href="#contacto" class="inline-block mt-2 text-secondary font-medium hover:text-premium">
                            Conoce más <i class="fas fa-arrow-right ml-1"></i>
                        </a>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="relative">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS8bcKQElo62npGKRp2lM1I2vE5aBKbdLaJmO6owXo5Nzgk4qVsDaJ8NOzFUiPkmAV_yrU&usqp=CAU"
                            alt="Net Inmobiliario" class="w-full h-64 object-cover">
                        <div class="absolute top-0 left-0 bg-primary text-white py-2 px-4 rounded-br-xl">
                            <i class="fas fa-home mr-2"></i> Inmobiliaria
                        </div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-2xl font-bold text-primary mb-3">Net Inmobiliario</h3>
                        <p class="text-ink mb-4">Conjuga todas las modalidades inmobiliarias, brindando token
    ...
    <section id="inversion" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
                <div
                    class="bg-white p-8 rounded-xl border border-neutral-light shadow-md shadow-ink hover:shadow-lg transition-shadow duration-300">
                    <div class="flex items-center mb-6">
                        <div class="bg-premium p-3 rounded-lg text-white mr-4">
                            <i class="fas fa-chart-pie text-2xl"></i>
                        </div>
                        <h3 class="text-2xl font-bold text-primary">Franquicia API</h3>
                    </div>
                ...
                <div
                    class="bg-white p-8 rounded-xl border border-gray-200 shadow-md shadow-ink hover:shadow-lg transition-shadow duration-300">
                    <div class="flex items-center mb-6">
                        <div class="bg-premium p-3 rounded-lg text-white mr-4">
                            <i class="fas fa-store text-2xl"></i>
                        </div>
                        <h3 class="text-2xl font-bold text-primary">Franquicia de Operación</h3>
                    </div>
            ...
            <div class="bg-neutral-50 rounded-2xl p-8 md:p-12 shadow-md shadow-ink border border-neutral-light">
                <h3 class="text-2xl font-bold text-primary mb-6">Otras formas de inversión</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="flex items-start">
                        <div class="bg-premium p-3 rounded-full text-white mr-4 flex-shrink-0">
                            <i class="fas fa-project-diagram text-xl"></i>
                        </div>
                        <div>
                            <h4 class="text-xl font-medium text-primary mb-2">Inversión en proyectos avalados</h4>
                            <p class="text-ink">Participa en proyectos específicos respaldados por la compañía,
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            <h4 class="text-xl font-medium text-primary mb-2">Distribución de productos</h4>
                            <p class="text-ink">Conviértete en distribuidor de productos de las distintas marcas
                ...
                <div class="mt-8 text-center">
                    <a href="#contacto"
                        class="inline-block px-8 py-3 bg-primary text-white rounded-md hover:bg-secondary transition duration-300">
    ...
    <section id="diferencias" class="py-20 bg-gradient-to-r from-primary to-secondary text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
            ...
            <div class="mt-16 text-center">
                <a href="#contacto"
                    class="inline-block px-8 py-4 bg-white text-primary rounded-md font-medium text-lg hover:bg-neutral-light transition duration-300">
    ...
    <!-- Contacto -->
    <section id="contacto" class="py-20 bg-neutral-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-primary">Comienza tu camino con ActivosNetwork</h2>
                <p class="mt-4 text-xl text-secondary">Estamos listos para responder todas tus preguntas</p>
                <div class="h-1 w-24 bg-premium mx-auto mt-4"></div>
            </div>

            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                <div class="bg-white rounded-xl shadow-md shadow-ink p-8">
                    <h3 class="text-2xl font-bold text-primary mb-6">Contáctanos</h3>
                    <form>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                <label for="nombre" class="block text-sm font-medium text-ink mb-1">Nombre
                                    completo</label>
                                <input type="text" id="nombre" name="nombre"
                                    class="w-full px-4 py-2 border border-neutral-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            <div>
                                <label for="email" class="block text-sm font-medium text-ink mb-1">Correo
                                    electrónico</label>
                                <input type="email" id="email" name="email"
                                    class="w-full px-4 py-2 border border-neutral-light rounded-md focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                <label for="telefono"
                                    class="block text-sm font-medium text-ink mb-1">Teléfono</label>
                                <input type="tel" id="telefono" name="telefono"
                                    class="w-full px-4 py-2 border border-neutral-light rounded-md focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            <div>
                                <label for="interes" class="block text-sm font-medium text-ink mb-1">Me
                                    interesa</label>
                                <select id="interes" name="interes"
                                    ...
                                    <option value="ActivosNetwork">ActivosNetwork</option>
                        ...
                        <div class="mb-6">
                            <label for="mensaje" class="block text-sm font-medium text-ink mb-1">Mensaje</label>
                            <textarea id="mensaje" name="mensaje" rows="4"
                                class="w-full px-4 py-2 border border-neutral-light rounded-md focus:ring-blue-500 focus:border-blue-500"></textarea>
                        </div>
                        <button type="submit"
                            class="w-full bg-primary text-white py-3 px-4 rounded-md hover:bg-secondary transition duration-300 font-medium">
                            Enviar mensaje
                        </button>
                    </form>
                </div>

                <div class="bg-primary text-white rounded-xl shadow-lg overflow-hidden">
                    <div class="p-8">
                        <h3 class="text-2xl font-bold mb-6">Información de contacto</h3>
                        <div class="space-y-6">
                            <div class="flex items-start">
                                <div class="bg-white rounded-full text-primary mr-4">
                                    <div class="w-10 h-10 flex items-center justify-center">
                        ...
                        <div class="mt-8">
                            ...
                            <div class="flex space-x-4">
                                ...
                                <a href="#"
                                    class="bg-white text-primary p-3 rounded-full hover:bg-neutral-light transition duration-300">
                    ...
                    {{-- <div class="w-full h-64 bg-neutral-light">
    ...
    <section class="py-16 bg-primary text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="text-xl mb-8">Únete a ActivosNetwork y descubre un nuevo camino hacia la libertad financiera
                    y el
                    bienestar.</p>
                <a href="#contacto"
                    class="inline-block px-8 py-4 bg-white text-primary rounded-md font-medium text-lg hover:bg-neutral-light transition duration-300">
