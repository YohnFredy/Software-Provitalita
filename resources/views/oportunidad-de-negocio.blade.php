...
<body class="min-h-screen bg-neutral-100 dark:bg-neutral-100 text-ink">
    <div class="py-8 md:py-10 mx-auto max-w-4xl">
        ...
        <main class="mt-4 md:mt-8">
            ...
            <div class="mx-auto max-w-4xl sm:px-2">
                <div class="video-container relative">
                    <video id="fornuvi-video" class="w-full h-full object-contain sm:rounded-t-lg shadow-md" controls
                        ...
                        <source src="{{ asset('storage/videos/Transforma-tus-gastos-en-ingresos-con-FORNUVI.mp4') }}"
                            type="video/mp4">
            ...
            <section class="mt-10 px-2 md:px-4">
            ...
            <section class=" mt-8 md:mt-12 px-2 md:px-4">
                ...
                <section class=" mt-8 md:mt-12 px-2 md:px-4">
                    <div class=" bg-white rounded-2xl shadow-lg p-4 md:p-8">
                        <h2 class="text-xl sm:text-2xl md:text-3xl font-bold text-center mb-6 md:mb-8">Preguntas
                            Frecuentes
                        </h2>

                        <div class="space-y-3 md:space-y-4">
                            <div class="border border-gray-200 rounded-lg p-3 md:p-4">
                                <h3 class="font-bold text-base md:text-lg text-primary mb-1 md:mb-2">¿Necesito
                                    experiencia
                                    previa?</h3>
                                <p class="text-ink text-sm md:text-base">No, nuestro sistema está diseñado para
                                    cualquier
                                    persona,
                                    independientemente de su experiencia. Te proporcionamos toda la capacitación
                                    necesaria.
                                </p>
                            </div>

                            <div class="border border-gray-200 rounded-lg p-3 md:p-4">
                                <h3 class="font-bold text-base md:text-lg text-primary mb-1 md:mb-2">¿Cuánto tiempo
                                    debo
                                    dedicar?</h3>
                            ...
                            <div class="border border-gray-200 rounded-lg p-3 md:p-4">
                                <h3 class="font-bold text-base md:text-lg text-primary mb-1 md:mb-2">¿Cómo recibo mis
                                    ganancias?</h3>
                                <p class="text-ink text-sm md:text-base">Tus ganancias se acumulan en tu cuenta
                                    personal y
            ...
            <footer class="text-center mt-8 border-t border-gray-800 mx-4">
                ...
                <p class="text-gray-500 text-sm md:text-base mt-4">&copy; {{ date('Y') }} FORNUVI. Todos los
                    derechos
                    reservados.</p>
