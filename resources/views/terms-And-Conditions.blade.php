...
<flux:modal name="edit-profile" class="w-full">
    ...
    <div class="p-4 text-sm text-ink text-justify">
        ...
        <p class="mt-2">Bienvenido a ActivosNetworks. Al registrarse y participar en nuestro plan de pagos, usted
        ...
        <p class="mt-2">Para ser parte de ActivosNetworks, debe:</p>
        ...
        <ul class="list-disc pl-6 mt-2">
            ...
            <li>Respetar las normas y regulaciones establecidas por ActivosNetworks.</li>
        ...
        <p class="mt-2">El plan de pagos de ActivosNetworks se basa en la acumulación de puntos y la generación de
        ...
        <ul class="list-disc pl-6 mt-2">
            ...
            <li>Otros métodos aprobados por ActivosNetworks.</li>
        </ul>
        ...
        <p class="mt-2">Los pagos realizados no son reembolsables salvo en casos específicos aprobados por la
            administración de ActivosNetworks. Cualquier solicitud de reembolso debe realizarse por escrito dentro
            de los 15 días posteriores al pago.</p>
        

        <h2 class="text-md font-semibold mt-4">7. Cancelación y Terminación</h2>
        <p class="mt-2">ActivosNetworks se reserva el derecho de cancelar la cuenta de un usuario si se detecta
        ...
        <p class="mt-2">El usuario puede solicitar la cancelación de su cuenta en cualquier momento enviando una
            solicitud por escrito al soporte de ActivosNetworks.</p>

        <h2 class="text-md font-semibold mt-4">8. Modificaciones a los Términos</h2>
        <p class="mt-2">ActivosNetworks puede actualizar estos términos en cualquier momento. Se notificará a los
        ...
        <p class="mt-2">La información personal proporcionada por los usuarios será tratada conforme a nuestra
            política de privacidad. ActivosNetworks se compromete a no compartir datos con terceros sin el
        ...
        <p class="mt-2">ActivosNetworks no garantiza ingresos mínimos ni éxito financiero a los participantes. La
        ...
        <p class="mt-2">Cualquier controversia relacionada con estos términos será resuelta mediante negociación
            ...
            ActivosNetworks tenga su sede.</p>

        <h2 class="text-md font-semibold mt-4">12. Contacto</h2>
        <p class="mt-2">Si tiene preguntas sobre estos términos, puede contactarnos a soporte@activosnetworks.com
