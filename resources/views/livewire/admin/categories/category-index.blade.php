...
@endif
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mt-8 mb-4 px-6">
        <div>
            ...
            <p class="text-sm text-ink mt-1">Administra tus categorías de productos</p>
        </div>
                    ...
                    @forelse ($categories as $category)
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-8 w-8 bg-primary/10 rounded-md flex items-center justify-center">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if ($category->is_active)
                                    <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-premium/5 text-premium">
                            ...
                            <td colspan="4" class="px-6 py-16 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    @if (!empty($this->searchTerms))
                                        <flux:button wire:click="clearSearch"
                                            class=" mt-4">
                                            Limpiar búsqueda
                                        </flux:button>
                                    @endif
