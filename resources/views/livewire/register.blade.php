<div class="flex flex-col gap-6">
    ...
    <form wire:submit="save">
        ...
        <div class="grid grid-cols-2 gap-x-3">
            ...
            <!-- Sexo -->
            <div class="col-span-2 sm:col-span-1">
                <x-radio name="sex" label="Sexo:" wire:model="sex" :options="[['value' => 'male', 'label' => 'Masculino'], ['value' => 'female', 'label' => 'Femenino']]" />
            </div>
            ...
            <!-- Teléfono -->
            <div class="col-span-2 sm:col-span-1">
                <x-input wire:model="phone" label="Teléfono:" type="text" for="phone" required
