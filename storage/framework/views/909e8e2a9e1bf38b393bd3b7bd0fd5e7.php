...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => '#']); ?><?php echo e($product->category->name ?? 'Sin categoría'); ?>
...
<?php endif; ?>
        ...
        <div class="grid grid-cols-8 gap-4 lg:gap-x-10 lg:px-10">
            <div class="hidden col-span-1 sm:flex items-center">
                <div>
                    <!--[if BLOCK]><![endif]--><?php if($product->images->count() > 1): ?>
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $product->images->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button class=" shadow rounded-lg" wire:click="changeImage(<?php echo e($index); ?>)"
                                class="aspect-w-1 aspect-h-1 rounded-md overflow-hidden <?php echo e($currentImageIndex === $index ? 'ring-2 ring-indigo-500' : ''); ?>">
                                <img src="<?php echo e(asset('storage/' . $image->path)); ?>" alt="<?php echo e($product->name); ?>"
                    ...
                    <?php else: ?>
                        <?php if($product->images->count() > 0): ?>
                            <img class="w-full rounded-lg shadow-md"
                                src="<?php echo e(asset('storage/' . $product->images[$currentImageIndex]->path)); ?>"
            ...
            <div class="sm:hidden col-span-8 flex justify-center gap-2 px-1 pt-1 pb-2 overflow-x-auto ">
                <!--[if BLOCK]><![endif]--><?php if($product->images->count() > 1): ?>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button wire:click="changeImage(<?php echo e($index); ?>)"
                            class="flex-shrink-0 w-16 h-16 shadow rounded-lg <?php echo e($currentImageIndex === $index ? 'ring-2 ring-neutral-200' : ''); ?>">
                            <img src="<?php echo e(asset('storage/' . $image->path)); ?>" alt="<?php echo e($product->name); ?>"
                                class="w-full h-full object-center object-cover rounded-lg">
                        </button>
            ...
            <div class="col-span-8 sm:col-span-4 mt-3">
                <div>
                    <div class="flex items-center justify-between">
                        <h1 class="text-3xl font-extrabold tracking-tight text-primary capitalize"><?php echo e($product->name); ?>

                        </h1>
                        <!--[if BLOCK]><![endif]--><?php if($product->brand): ?>
                            <a href="" class="text-sm font-medium text-premium hover:text-primary">
                    ...
                    <div class="mt-4">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($product->maximum_discount > 0): ?>
                            <p class="text-sm text-primary">
                                Descuento Usuarios Activos: <?php echo e($product->maximum_discount); ?>%
                            </p>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($product->stock > 0 || $product->allow_backorder): ?>
                                    ...
                                    <p class="ml-2 text-sm text-primary">
                                        <!--[if BLOCK]><![endif]--><?php if($product->stock > 0): ?>
                                            En stock (<?php echo e($product->stock); ?> disponibles)
                                        <?php else: ?>
                    ...
                    <div class="mt-8">
                        <div class="flex items-center">
                            ...
                            <div class="flex items-center border border-neutral-300 rounded-md">
                                ...
                                <span class="px-3 py-1 text-ink"><?php echo e($quantity); ?></span>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['icon' => 'shopping-cart','variant' => 'primary','wire:click' => 'addToCart','class' => ' w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'shopping-cart','variant' => 'primary','wire:click' => 'addToCart','class' => ' w-full']); ?>
                                Agregar al carrito
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($product->pts_base): ?>
                        <div class="mt-6">
                            <div class="flex items-center">
                                <svg class="h-5 w-5 text-premium" fill="currentColor" viewBox="0 0 20 20">
                                    <path
                                ...
                                <p class="ml-2 text-sm text-primary">
                                    Este producto otorga <?php echo e(number_format($product->pts_base, 2)); ?> puntos
                                </p>
                            </div>
                        </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                    <!--[if BLOCK]><![endif]--><?php if($product->commission_income): ?>
                        <div class="mt-2">
                            <div class="flex items-center">
                                <svg class="h-5 w-5 text-premium" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                ...
                                <p class="ml-2 text-sm text-danger">
                                    Comisión: $<?php echo e(number_format($product->commission_income, 0)); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::modal.index','data' => ['wire:model.live' => 'modalCart','dismissible' => false,'class' => '']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'modalCart','dismissible' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'class' => '']); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-primary! pr-6','size' => 'lg']); ?>Lo que agregas al carrito
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <div
            ...
            <div class="col-span-10 sm:col-span-1 flex justify-center">
                <img class="w-12 h-12 rounded-md border border-neutral-300 object-cover mb-1"
                    src="<?php echo e(asset('storage/' . $product->latestImage->path)); ?>" alt="<?php echo e($product->name); ?>">
            </div>
        ...
        <div class=" grid sm:grid-cols-3 gap-2 pt-3">
            <a href="<?php echo e(route('products.index')); ?>" class="sm:col-start-2">
                <?php if (isset($component)) { $__componentOriginalc04b147acd0e65cc1a77f86fb0e81580 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580 = $attributes; } ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','class' => 'w-full']); ?>Seguir Comprando <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580)): ?>
<?php $attributes = $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580; ?>
<?php unset($__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580); ?>
...
<?php endif; ?>
            ...
            <a href="<?php echo e(route('products.cart')); ?>">
                <?php if (isset($component)) { $__componentOriginalc04b147acd0e65cc1a77f86fb0e81580 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['variant' => 'primary','class' => 'w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::button'); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','class' => 'w-full']); ?>Ir al carro <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580)): ?>
<?php $attributes = $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580; ?>
<?php unset($__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580); ?>
...
<?php /**PATH C:\Users\Fredy\Herd\fornuvi\resources\views/livewire/product/product-show.blade.php ENDPATH**/ ?>