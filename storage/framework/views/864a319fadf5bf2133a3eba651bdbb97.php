...
$message = $__bag->first($__errorArgs[0]); ?>
    <p <?php echo e($attributes->merge(['class' => 'text-sm text-palette-400 '])); ?>><?php echo e($message); ?></p>
<?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
<?php /**PATH C:\Users\Fredy\Herd\fornuvi\resources\views/components/input-error.blade.php ENDPATH**/ ?>