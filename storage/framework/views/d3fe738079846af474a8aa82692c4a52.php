                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b border-neutral-200 hover:bg-neutral-50">
                                ...
                                <td class="px-2 sm:px-6 py-3 text-center">$<?php echo e(number_format($item->final_price, 0)); ?>

                                </td>
                                <td class="px-2 sm:px-6 py-3 text-center"><?php echo e(number_format($item->pts, 2)); ?></td>
                                <td class="px-2 sm:px-6 py-3 text-center">
                                    $<?php echo e(number_format($item->final_price * $item->quantity, 0)); ?>
            ...
            <div class=" sm:flex justify-end">
                <div class="mt-4 sm:w-1/2">
                    ...
                    <div class="flex justify-between items-center border-t pt-2">
                        ...
                        <span>$<?php echo e(number_format($subtotal - $order->discount, 0)); ?></span>
                    </div>
                    <div class="flex justify-between items-center border-t pt-2">
                    ...
                    <div class="flex justify-between items-center border-t pt-2">
                        ...
                        <span class="">$<?php echo e(number_format($order->total, 0)); ?></span>
                    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button-dynamic','data' => ['id' => 'custom-button-payment']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'custom-button-payment']); ?>
