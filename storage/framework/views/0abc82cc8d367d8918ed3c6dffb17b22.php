...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::sidebar.toggle','data' => ['class' => 'lg:hidden text-danger! hover:text-primary!','icon' => 'bars-2','inset' => 'left']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'lg:hidden text-danger! hover:text-primary!','icon' => 'bars-2','inset' => 'left']); ?>
...
<?php endif; ?>
        ...
        <a href="<?php echo e(route('home')); ?>" class="ml-2 mr-5 flex items-center space-x-2 lg:ml-0" wire:navigate>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-437751494-0', $__slots ?? [], get_defined_vars());
