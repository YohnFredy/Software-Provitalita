...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::sidebar.index','data' => ['sticky' => true,'stashable' => true,'class' => ' shadow-lg bg-zinc-50  shadow-ink']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['sticky' => true,'stashable' => true,'class' => ' shadow-lg bg-zinc-50  shadow-ink']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::navlist.item','data' => ['icon' => $link['icon'],'href' => route($link['route']),'current' => request()->routeIs($link['routeIs']),'wire:navigate' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH C:\Users\Fredy\Herd\fornuvi\resources\views/components/layouts/app/admin.blade.php ENDPATH**/ ?>